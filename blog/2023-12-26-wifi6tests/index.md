...
Для того, чтобы убедиться что мы упремся в кабельное соединение,
...
Также мы проверил пару тестов передачи файлов по ssh и через протокол netcat. Файлы передаются еще медленнее !
